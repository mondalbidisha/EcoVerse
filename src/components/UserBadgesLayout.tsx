  ...
  return (
    <>
      ...
      <div className="text-justify text-slate-100 sm:text-sm md:text-xl font-medium opacity-90 tracking-[2px] mb-10 md:px-20">
        Your commitment to a greener future is truly inspiring. Every action you take helps create a more sustainable
        world for everyone. Keep up the fantastic work, and continue to make a positive impact. Together, we can achieve
          ...
          <div className="flex flex-row">
            {badges.map((badge: any) => (
              <div key={badge.id} className="flex-shrink-0">
                <img src={getBadgeIconPath(badge.name)} width={150} height={150} className="rounded-full" />
