...
export function DockElements(props: any) {
  ...
  const categoryIconMapper = (category: any) => {
    switch(category.name.toLowerCase()) {
      case "eco habits":
        return (
          <Icons.ecohabit className="h-6 w-6" />
        )
      case "water":
        return (
          <Icons.water className="h-6 w-6" />
        )
      case "waste":
        return (
          <Icons.waste className="h-6 w-6" />
        )
      case "energy":
        return (
          <Icons.energy className="h-6 w-6" />
        )
      case "transportation":
        return (
          <Icons.transportation className="h-6 w-6" />
        )
      case "food and drinks":
        return (
          <Icons.foodanddrink className="h-6 w-6" />
        )
      case "shopping":
        return (
          <Icons.shopping className="h-6 w-6" />
        )
    }
  }
...
const Icons = {
  ...
  transportation: (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-bike">
  ...
  ecohabit: (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-flower">
