  ...
  return (
    <>
      <div className="text-justify text-slate-100 sm:text-sm md:text-xl font-medium opacity-90 tracking-[2px] mb-5">
        At EcoVerse, we believe every sustainable action makes a real difference. Though each individual effort may seem
        small, consistent actions combined with others create a significant impact.
      </div>
      ...
      <div className="text-justify text-slate-100 sm:text-sm md:text-xl font-medium opacity-90 tracking-[2px] mt-5">
        Given certain circumstances, we have researched and determined an estimated typical impact for each action.
        While individual impacts may vary, a large number of users allows for these variations to average out.
      </div>
